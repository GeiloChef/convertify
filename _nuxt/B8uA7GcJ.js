const e=`# Terabytes per Second (TBps)
...
*Understanding terabytes per second helps grasp the scale of modern data transfer capabilities, essential for appreciating the infrastructure powering today’s data-driven world.*`;export{e as default};
