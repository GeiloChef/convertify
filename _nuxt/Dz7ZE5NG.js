const e=`# Kilometers per Day (km/day)
...
*Use these quick references to easily switch between units and better understand movement rates over different scales.*`;export{e as default};
